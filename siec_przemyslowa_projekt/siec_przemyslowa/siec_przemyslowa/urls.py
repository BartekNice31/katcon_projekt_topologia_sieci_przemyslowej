"""
URL configuration for siec_przemyslowa project.
...
urlpatterns = [
    path('admin/', admin.site.urls,name='admins_page'),
    ...
    path('uzytkownicy_aplikacji',views.get_all_users,name='uzytkownicy_aplikacji')
]
